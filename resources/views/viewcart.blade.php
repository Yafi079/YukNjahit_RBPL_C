...
<body>
    ...
    <div class="order-container">
        ...
        @foreach ($cart as $c)
            <div class="order-item">
                <div class="row">
                    <div class="media p-3">
                        <img src="{{ url('/data_file/' . $c->file) }}" class="rounded" class="img-fluid"
                            style="float:left">
                ...
                <a href="/cart/hapus/{{ $c->idCart }}" class="btn btn-danger" style="margin-left: 1%">Hapus</a>
            </div>
        @endforeach
    </div>
    ...
    <div id="checkout-button">
        <a href="/checkout"><button type="button" class="btn btn-danger" style="float:right">Checkout</button></a>
    </div>
    ...
    <div class="footer">
        ...
        <div class="row">
            ...
            <div class="col-md">
                ...
                <br>
                <a href="/profilepembeli"><span>My Account</span></a>
