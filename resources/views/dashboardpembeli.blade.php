...
<body>
    ...
    <header>
        <div class="jumbotron">
            <form action="/dashboardpembeli/cari" method="get">
            <input class="input" type="text" name="cari" placeholder="Cari Baju .." value="{{ old('cari') }}">
            <input type="submit" class="btn btn-info" value="CARI">
	        </form>
            <div class="nav-container">
                <ul class="nav nav-pills nav-justified">
                    <li class="active"><a href="/dashboardpembeli/filter/1">Men</a></li>
                    <li><a href="/dashboardpembeli/filter/2">Women</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <div class="card" style="width:100%">
                    <img class="card-img-top" src="{{ url('/data_file/' . $g->file) }}" alt="Card image"
                        style="width:100%">
                    <div class="card-body">
                        <div><b>{{ $g->namaBaju }}</b></div>
                        <div class="order-harga">Rp.{{ $g->hargaBaju }}</div>
                        <div class="location">
                            <i class="fas fa-solid fa-location-dot"></i>
                            <span>{{ $g->alamat }}</span>
                        </div>
                        <a href="/viewbaju/{{ $g->idBaju }}" class="stretched-link"></a>
                    </div>
                </div>
            </div>
            @endforeach
