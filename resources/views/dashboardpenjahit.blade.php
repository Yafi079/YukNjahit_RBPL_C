...
<body>
    ...
    <header>
        <div class="jumbotron">
            <form action="/dashboardpenjahit/cari" method="get">
            <input class="input" type="text" name="cari" placeholder="Cari Baju .." value="{{ old('cari') }}">
            <input type="submit" class="btn btn-info" value="CARI">
	        </form>
            <div class="nav-container">
                <ul class="nav nav-pills nav-justified">
                    <li class="active"><a href="/dashboardpenjahit/filter/1">Men</a></li>
                    <li><a href="/dashboardpenjahit/filter/2">Women</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="card" style="width:100%">
                    <img class="card-img-top" src="{{ url('/data_file/' . $g->file) }}" alt="Card image"
                        ...
                        <div class="card-body">
                            ...
                            <a href="/viewbajupenjahit/{{ $g->idBaju }}" class="stretched-link"></a>
                        </div>
                </div>
            </div>
            @endforeach
