...
<body>
    <header>
        ...
        <div class="jumbotron">
            <h3>My Profile</h3>
            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><h6>
        ...
        <div class="form-container rounded">
            <form>
                <div class="form-group row">
                    <label for="name" class="col-md-2 col-form-label">Tailor Shop</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="name" placeholder="{{ $p->name }}" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        placeholder="{{ $p->email }}" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="phone" class="col-md-2 col-form-label">No. Telepon</label>
                    <div class="col-md-10">
                        <input type="tel" class="form-control" id="phone" placeholder="{{ $p->notelp }}" disabled>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="address" class="col-md-2 col-form-label">Location</label>
                    <div class="col-md-10">
                        <input class="form-control" id="address" rows="3"
                        placeholder="{{ $p->alamat }}" disabled>
                    </div>
                </div>
                <div id="confirm-button">
                    <a href="/profilepenjahit/edit/{{ $p->id }}"><button type="button" class="btn btn-danger btn-lg" style="float:right" >
                        <i class="fa-regular fa-pen-to-square"></i> Edit</button></a>
                </div>
            </form>
        </div>
