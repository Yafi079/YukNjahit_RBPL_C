...
<body>
        ...
        <div class="form-container rounded">
            <form>
                ...
                <div id="confirm-button">
                    <a href="/profilepembeli/edit/{{ $p->id }}"><button type="button" class="btn btn-danger btn-lg" style="float:right" >
    ...
    <div class="footer">
        <div class="row">
            ...
            <div class="col-md">
                <a href="/myorder"><i class="fas fa-sharp fa-regular fa-receipt"></i>
                <br>
