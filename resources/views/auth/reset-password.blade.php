    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="email" name="email" id="email" :value="old('email', $request->email)" required autofocus placeholder="Email">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div id="confirm-button" style="margin-left: 21%">
                <button class="btn "> {{ __('Reset Password') }}</button>
            </div>
            <br>
        </form>
       <!-- Validation Errors -->
