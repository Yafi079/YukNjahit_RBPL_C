...
<body>
    ...
    <div class="container">
        ...
        <b><div class="mb-4 text-sm text-gray-600" style="margin-left: 20%;margin-right:20%">
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div id="confirm-button" style="margin-left: 17%">
                <button class="btn ">{{ __('Email Password Reset Link') }}</button>
            </div>
            <br>
        </form>
        <x-auth-session-status class="mb-4" :status="session('status')" style="margin-left:35% "/>
        <!-- Validation Errors -->
        <x-auth-validation-errors class="mb-4" :errors="$errors" />
    </div>
